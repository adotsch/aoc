...
P:(M$)\[n-2;M]                                                                  / number of 1,...n-1 length paths
c:c[0],1#where 1=P[n-2]c 0                                                      / two neigbour corners
g:c[0],raze{[i]where[1=P[i][c 0]] inter where[1=P[n-i+3][c 1]]}'[til n-2],c 1   / shortest path between c[0]-c[1]
...
t0:orient[;i g[1;0];hmir;rots;below] orient[i g[0;0];i g[0;1];rots;rots;right]  / orient g[0;0] to g[0;1] and g[1;0]
